...
export function createApiKeysRouter(db: DbClient) {
      ...
      describeRoute({
        ...
        responses: {
          200: {
            ...
            content: {
              'application/json': {
                schema: resolver(projectKeyResponseSchema),
              },
            },
          },
          404: {
...
export type ProjectKeysRouter = ReturnType<typeof createApiKeysRouter>;
